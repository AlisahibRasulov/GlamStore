...
const Header = () => {
  ...
  return (
    ...
    <h4>Glam<span className='text-secondary'>Store</span></h4>
    </Link>
    {/* navbar */}
         ...
         <Navbar containerStyles={`${menuOpened ? "flex items-start flex-col gap-y-12 fixed top-20 right-8 p-12 bg-white rounded-3xl shadow-md w-64 medium-16 ring-1 ring-slate-900/5 transition-all duration-300" 
          ...
          <div className="flexBetween gap-x-3 sm:gap-x-8">
            ...
            <Link className='flex relative'>
              ...
              <span className='bg-secondary text-white text-sm absolute -top-2.5 -right-2.5 flexCenter w-5 h-5 rounded-full'>0</span>
            </Link>
